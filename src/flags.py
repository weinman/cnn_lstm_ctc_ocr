...
tf.app.flags.DEFINE_integer('training_batch_size',2**5,
                            """Mini-batch size""")
...
tf.app.flags.DEFINE_string('filename_pattern_training','words-*',
                           """File pattern for train input data""")
tf.app.flags.DEFINE_integer('num_input_threads_training',4,
...
tf.app.flags.DEFINE_string('filename_pattern_testing','val/words-*',
                           """File pattern for test input data""")
tf.app.flags.DEFINE_integer('num_input_threads_testing',4,
                          """Number of readers for input data""")
